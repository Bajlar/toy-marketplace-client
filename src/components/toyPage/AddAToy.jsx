...
const AddAToy = () => {
  ...
  const handleAddToy = event => {
    ...
    fetch("https://toy-street-server.vercel.app/toys", {
      method: "POST",
      headers: {
      ...
      <div className="p-2 md:py-4 md:px-4">
        ...
        <form onSubmit={handleAddToy}>
          <div className="md:flex mb-2 gap-4">
            ...
            <div className="form-control md:w-1/2">
              <label className="label">
                <span className="label-text text-2xl font-semibold">Toy Name</span>
              </label>
              <label className="input-group">
                <input
                  type="text"
          ...
          <div className="text-center my-7">
            <input type="submit" className="btn btn-secondary capitalize" value="Add Toy" /> 
          </div>
        </form>
      </div>
    </div>
